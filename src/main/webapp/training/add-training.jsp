...
<body>
    ...
    <form action="../workout-web-app" method="POST">
        ...
        <input type="text" name="trainingName" class="training-name-field" placeholder="Назва тренування"/>
        ...
        <input type="submit" value="Створити тренування" class="add-button training" onclick="setRowsAndExercisesMap()"/>
